...
double Kp = 15; //Set this first 20
...
void setup() {
  ...
  // initialize device
    ...
    //mpu.setZAccelOffset(1688); 
     mpu.setXGyroOffset(120); //-479
    mpu.setYGyroOffset(-4);   //84
    mpu.setZGyroOffset(48);   //15
    mpu.setZAccelOffset(9322);   //1638
...
void Reverse(){
    ...
    digitalWrite(10,0);
    digitalWrite(11,1); 
    analogWrite(A1,output*-1); 
    analogWrite(A2,output*-1);
    Serial.print("R");
}
