...
double Kp = 50; //21 Set this first
double Kd =0.9; //0.8 Set this secound  0.9
double Ki = 100; //140 Finally set this   50
...
*/
    ...
    mpu.setXGyroOffset(121); //-479
    mpu.setYGyroOffset(-6);   //84
    mpu.setZGyroOffset(43);   //15
    mpu.setZAccelOffset(15493);   //1638
...
void loop() {
    ...
    while (!mpuInterrupt && fifoCount < packetSize)
    {
       ...
       pid.Compute();
        ...
        if (input<175 || input>183){//If the Bot is falling 
